...
const ChiefComplaintPopUp = ({onClose}) => {
    ...
    return (
        <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 inset-0 overflow-y-auto flex items-center justify-center'>
            ...
            <div className="mb-4">
                <label htmlFor="chiefComplaint" className="block text-gray-700 font-bold mb-2">
                ...
                <option value="Chief Complaint 1">Chief Complaint 1</option>
                <option value="Chief Complaint 2">Chief Complaint 2</option>
                <option value="Chief Complaint 3">Chief Complaint 3</option>
                </select>
            </div>
