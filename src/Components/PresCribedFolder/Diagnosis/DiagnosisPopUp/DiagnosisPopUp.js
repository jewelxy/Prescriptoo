        ...
        <div className='' >
            <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 inset-0 overflow-y-auto flex items-center justify-center'>
                <form onSubmit={handleSubmit} className='mx-auto mt-8 max-w-3xl bg-stone-100 border-neutral-950 p-8'>
                    <div className="mb-4">
                        <label htmlFor="diagonosis" className="block text-gray-700 font-bold mb-2">
                            Select diagonosis identified
                        </label>
                        <select
                            id="diagonosis"
                            name="diagonosis"
                            className="appearance-none border rounded w-full py-1 px-3 text-white-700 leading-tight focus:outline-none focus:shadow-outline"
                            value={diagonosis}
                            onChange={(e) => setDiagonosis(e.target.value)}
                        >
                            <option value="">--Select--</option>
                            <option value="Diagonosis 1">Diagonosis 1</option>
                            <option value="Diagonosis 2">Diagonosis 2</option>
                            <option value="Diagonosis 3">Diagonosis 3</option>
                        </select>
                    </div>
